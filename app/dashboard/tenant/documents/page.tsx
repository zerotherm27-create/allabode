...
export const metadata: Metadata = { title: "My Documents", robots: { index: false } };
...
export default async function TenantDocumentsPage() {
  ...
  const [{ data: docData }, { data: tenantRow }] = await Promise.all([
  ...
  return (
    <DashboardShell role="Tenant" nav={nav} userName={tenantName}>
      <div className="mx-auto max-w-3xl">
        <h1 className="font-display text-2xl font-bold text-navy">My Documents</h1>
            ...
            <Panel title="No documents yet">
              <div className="py-8 text-center">
                ...
                <p className="mt-3 text-sm text-slate">
                  No documents have been shared with you yet. Your property manager will upload documents here — such as your signed lease contract.
                </p>
              </div>
            </Panel>
          ) : (
