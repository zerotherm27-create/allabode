...
const LEASE_TERM_LABEL: Record<string, string> = { "6": "6 Months", "12": "12 Months", "24": "24 Months" };
const PET_LABEL: Record<string, string> = { allowed: "Pets Allowed", small_pets: "Small Pets Only", no_pets: "No Pets" };
const SMOKING_LABEL: Record<string, string> = { allowed: "Allowed", balcony_only: "Balcony Only", no_smoking: "Strictly No Smoking" };
const YN_LABEL: Record<string, string> = { allowed: "Allowed", not_allowed: "Not Allowed", subject_to_rules: "Subject to Condo Rules" };
const FURNISHING_LABEL: Record<string, string> = { fully: "Fully Furnished", semi: "Semi Furnished", bare: "Bare Unit" };
const COMMS_LABEL: Record<string, string> = { call: "Call", sms: "SMS", viber: "Viber", whatsapp: "WhatsApp", email: "Email" };
const RESPONSE_LABEL: Record<string, string> = { anytime: "Anytime", office_hours: "Office Hours", weekdays: "Weekdays Only" };
const PAYOUT_LABEL: Record<string, string> = { monthly: "Monthly", "15th": "Every 15th", "30th": "Every 30th" };
...
export function ownerIdTypeLabel(type: string | null | undefined): string {
  ...
  return labels[type || ""] || "Government ID";
}
